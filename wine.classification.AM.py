...
svm_param_grid = {'C': [0.2, 2, 12], 'kernel': ['linear', 'rbf', 'poly']}
...
sns.heatmap(conf_matrix, annot=True, fmt="d", cmap="pink", xticklabels=wine_dataset.target_names,
...
plt.figure(figsize=(8, 6))
sns.heatmap(conf_matrix_df, annot=True, fmt="d", cmap="pink", xticklabels=True, yticklabels=True)
...
true_labels = [0, 2, 3]  # Assuming the true labels for the new instances
...
new_instances_data = {
    ...
    'Ash': [2.4, 2.1, 2.9],
    'Alcalinity of Ash': [20.0, 18.0, 24.0],
    'Magnesium': [120, 90, 100],
